...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x003CD0E8
void IncRecord(uint32_t);
extern "C" void YellowAuto_003cd0e8() __asm__("_ZN6NetApp2QR19FieldScanRecordFuncEv");
extern "C" void YellowAuto_003cd0e8() {
IncRecord(0xA6u);
}
#endif
