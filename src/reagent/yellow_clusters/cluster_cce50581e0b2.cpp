...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x0015C684
void operator delete[](void*);
void* GetInstance();
void RemoveSystemEventListener(void*, void*);
extern "C" uint8_t* YellowAuto_0015c684(uint8_t* arg0) __asm__("_ZN11ExtSavedata21RegulationExtSaveDataD1Ev");
extern "C" uint8_t* YellowAuto_0015c684(uint8_t* arg0) {
*(uint32_t*)arg0 = *(uint32_t*)0x15C6C8;
if (*(uint32_t*)(arg0 + 0x1C) != 0) { operator delete[]((void*)(*(uint32_t*)(arg0 + 0x1C))); *(uint32_t*)(arg0 + 0x1C) = 0; }
RemoveSystemEventListener(GetInstance(), (void*)arg0);
return arg0;
}
#endif
