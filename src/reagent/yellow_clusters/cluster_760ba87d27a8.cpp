...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x0032C994
extern "C" void YellowAuto_0032c994(uint8_t* arg0) __asm__("_ZN4gfl215renderingengine10scenegraph8resource15GfBinaryMdlDataC1Ev");
extern "C" void YellowAuto_0032c994(uint8_t* arg0) {
*(uint32_t*)(arg0 + 4) = 0; *(uint32_t*)(arg0 + 8) = 0; *(uint32_t*)(arg0 + 12) = 0;
}
#endif
