...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x003ACA94
void* func_003ad9d8();
void func_001076a8(void*);
void func_003ace30(uint32_t, uint32_t, uint32_t, uint32_t);
void func_00107730(void*);
extern "C" void YellowAuto_003aca94(uint32_t arg0, uint32_t arg1, uint32_t arg2) __asm__("_ZN5Sound15ChangeAppBGMReqEjNS_9FadeFrameES0_");
extern "C" void YellowAuto_003aca94(uint32_t arg0, uint32_t arg1, uint32_t arg2) {
void* _t = func_003ad9d8(); func_001076a8(_t); func_003ace30(arg0, arg1, arg2, 2); func_00107730(_t);
}
#endif
