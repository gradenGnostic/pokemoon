...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x002E14F8
uint8_t* FUN_002e6b18(uint8_t*);
void SetButtonInputEnable(uint8_t*, int32_t, int32_t);
void SetButtonInvisible(uint8_t*, int32_t);
void SetButtonVisible(uint8_t*, int32_t, int32_t);
void FUN_002da164(uint8_t*, int32_t);
void SetInputEnabled(uint8_t*, int32_t);
extern "C" void YellowAuto_002e14f8(uint8_t* arg0, const uint8_t* arg1) __asm__("_ZN3App8PokeList17PokeListBaseFrame14RebootPokeListERNS0_13CONTEXT_PARAME");
extern "C" void YellowAuto_002e14f8(uint8_t* arg0, const uint8_t* arg1) {
uint8_t* t0 = *(uint8_t**)(arg0 + 0x48);
uint8_t* t1 = FUN_002e6b18(*(uint8_t**)(t0 + 0xA4));
if (*(arg1 + 0xB5) == 0) {
SetButtonInputEnable(t1, 7, 0);
SetButtonInvisible(t1, 7);
} else {
SetButtonInputEnable(t1, 7, 1);
SetButtonVisible(t1, 7, 0);
}
FUN_002da164(*(uint8_t**)(t0 + 0xA8), 5);
SetInputEnabled(t0, 1);
}
#endif
