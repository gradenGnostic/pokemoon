...
#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x0035E9CC
void FUN_004783e0(uint8_t*, const uint8_t*, int32_t);
extern "C" void YellowAuto_0035e9cc(uint8_t* arg0, int32_t arg1) __asm__("_ZN4gfl26system4Date7SetHourEi");
extern "C" void YellowAuto_0035e9cc(uint8_t* arg0, int32_t arg1) {
uint32_t tmp[2]; FUN_004783e0((uint8_t*)tmp, arg0, arg1); ((uint32_t*)arg0)[0] = tmp[0]; ((uint32_t*)arg0)[1] = tmp[1];
}
#endif

#if !defined(POKEMOON_SPLIT_FUNCTION) || POKEMOON_SPLIT_FUNCTION == 0x0035EA50
void FUN_0047889c(uint8_t*, const uint8_t*, int32_t);
extern "C" void YellowAuto_0035ea50(uint8_t* arg0, int32_t arg1) __asm__("_ZN4gfl26system4Date9SetMinuteEi");
extern "C" void YellowAuto_0035ea50(uint8_t* arg0, int32_t arg1) {
